...
const electionSchema = new mongoose_1.Schema({
    title: {
        type: String,
        required: [true, 'Le titre de l\'élection est requis'],
        trim: true
    },
    description: {
        type: String,
    ...
    status: {
        type: String,
        enum: Object.values(types_1.ElectionStatus),
        default: types_1.ElectionStatus.PENDING
    },
    createdAt: {
        type: Date,
        default: Date.now
...
exports.default = mongoose_1.default.model('Election', electionSchema);
